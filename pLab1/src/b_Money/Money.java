...
public class Money implements Comparable {
	...
	public String toString() {
		...
		return switch (a.length()) {
			case 1 -> "0.0" + a + " " + currency.getName();
			case 2 -> "0." + a + " " + currency.getName();
			default -> a.substring(0,a.length()-2) + "." + a.substring(a.length()-2) + " " + currency.getName(); //TODO check if it works later
		};
	}
	...
	public Boolean equals(Money other) {
		return amount == other.getAmount(); //TODO easy?
	}
	 ...
	 */
	public Money negate() {
		return new Money(amount*-1, currency); //TODO double check -amount
	}
	...
	public int compareTo(Object other) {
		return Integer.compare(sub((Money)other).getAmount(), 0);
	}
}